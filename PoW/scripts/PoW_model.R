...
filepath_rates <- "Rate_posterior_distributions/S_N10_datesAsYears_strict_priors_1780677028638.log"
filepath_rates <- "Rate_posterior_distributions/M_N10_strict_datesAsYears_priors_1780676794299.log"
filepath_rates <- "Rate_posterior_distributions/L_N10_datesAsYears_strict_priors_1780586813356.log"
...
filepath_distances <- "ultrametric_trees/2026-06-07_S_samples_PoW_1780859518014.trees"
filepath_distances <- "ultrametric_trees/2026-06-07_M_samples_PoW_excl_NC_077670_1780908892596.trees"
filepath_distances <- "ultrametric_trees/2026-06-07_L_samples_PoW_excl_NC_077671_1780908876702.trees"

filepath_HKYsubstitutionModel <- "ultrametric_trees/2026-06-07_S_samples_PoW_1780859518014.log"
filepath_HKYsubstitutionModel <- "ultrametric_trees/2026-06-07_M_samples_PoW_excl_NC_077670_1780908892596.log"
filepath_HKYsubstitutionModel <- "ultrametric_trees/2026-06-07_L_samples_PoW_excl_NC_077671_1780908876702.log"
...
meanrate_column <- which(strsplit(con[69],"\t")[[1]]=="clockRate") #For S
meanrate_column <- which(strsplit(con[69],"\t")[[1]]=="clockRate") # For M
meanrate_column <- which(strsplit(con[79],"\t")[[1]]=="clockRate") # For L
...
write.table(recreated_treefile, "./recreated_trees/2026-06-08_S_sampled_trees_fixed_mu.trees", sep = "\n", quote = FALSE, row.names = FALSE)

#import <sampled_trees.trees> created in the previous step from the directory
filename <- "./recreated_trees/2026-06-08_S_sampled_trees_fixed_mu.trees"
...
ape::write.nexus(importedtree, file="./PoW_transformed_trees/2026-06-08_S_PoWtransformed_fixed_mu.trees")
