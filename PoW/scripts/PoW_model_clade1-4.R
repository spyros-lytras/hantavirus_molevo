...
filepath_distances <- "../ultrametric_trees/S_Clade1-4_incl_NC_003466_excl_EU241680_EU241684_strict_ultrametric_clockRateFixed_1785411127775.trees"
filepath_distances <- "../ultrametric_trees/M_Clade1-4_excl_EU241643-EU241657_strict_ultrametric_clocRateFixed_1785406554429.trees"
filepath_distances <- "../ultrametric_trees/L_Clade1-4_strict_ultrametric_clockRateFixed_1785399938490.trees"

filepath_HKYsubstitutionModel <- "../ultrametric_trees/S_Clade1-4_incl_NC_003466_excl_EU241680_EU241684_strict_ultrametric_clockRateFixed_1785411127775.log"
filepath_HKYsubstitutionModel <- "../ultrametric_trees/M_Clade1-4_excl_EU241643-EU241657_strict_ultrametric_clocRateFixed_1785406554429.log"
filepath_HKYsubstitutionModel <- "../ultrametric_trees/L_Clade1-4_strict_ultrametric_clockRateFixed_1785399938490.log"
...
kappa_column <- which(strsplit(con3[49],"\t")[[1]]=="kappa")
frequencies1_column <- which(strsplit(con3[49],"\t")[[1]]=="freqParameter.1")
...
write.table(recreated_treefile, "../recreated_trees/2026-07-30_L_sampled_trees_fixed_mu.trees", sep = "\n", quote = FALSE, row.names = FALSE)

#import <sampled_trees.trees> created in the previous step from the directory
filename <- "../recreated_trees/2026-07-30_L_sampled_trees_fixed_mu.trees"
...
ape::write.nexus(importedtree, file="../PoW_transformed_trees/2026-07-30_L_PoWtransformed_fixed_mu.trees")
