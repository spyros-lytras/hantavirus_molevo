...
filepath_distances <- "../ultrametric_trees/S_Clade1-4_GHOST_BETS_ultrametric_1785494449320.trees"
filepath_distances <- "../ultrametric_trees/M_Clade1-4_GHOST_BETS_ultrametric_1785494249995.trees"
filepath_distances <- "../ultrametric_trees/L_Clade1-4_GHOST_BETS_ultametric_1785655858530.trees"

filepath_HKYsubstitutionModel <- "../ultrametric_trees/S_Clade1-4_GHOST_BETS_ultrametric_1785494449320.log"
filepath_HKYsubstitutionModel <- "../ultrametric_trees/M_Clade1-4_GHOST_BETS_ultrametric_1785494249995.log"
filepath_HKYsubstitutionModel <- "../ultrametric_trees/L_Clade1-4_GHOST_BETS_ultametric_1785655858530.log"
...
kappa_column <- which(strsplit(con3[146],"\t")[[1]]=="kappa") #For S
frequencies1_column <- which(strsplit(con3[146],"\t")[[1]]=="freqParameter.1")

kappa_column <- which(strsplit(con3[159],"\t")[[1]]=="kappa") #For M
frequencies1_column <- which(strsplit(con3[159],"\t")[[1]]=="freqParameter.1")

kappa_column <- which(strsplit(con3[386],"\t")[[1]]=="kappa") #For L
frequencies1_column <- which(strsplit(con3[386],"\t")[[1]]=="freqParameter.1")
...
write.table(recreated_treefile, "../recreated_trees/2026-08-29_L_clade1-4_GHOST_sampled_trees_fixed_mu.trees", sep = "\n", quote = FALSE, row.names = FALSE)

#import <sampled_trees.trees> created in the previous step from the directory
filename <- "../recreated_trees/2026-08-29_L_clade1-4_GHOST_sampled_trees_fixed_mu.trees"
...
ape::write.nexus(importedtree, file="../PoW_transformed_trees/2026-08-29_L_clade1-4_GHOST_PoWtransformed_fixed_mu.trees")
